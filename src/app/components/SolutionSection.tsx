...
const features = [
  {
    ...
    title: 'Arquitetura Imponente',
    description: 'Design brutalista que captura a atenção imediatamente e não deixa o usuário sair.',
  ...
  },
  {
    ...
    description: 'Carregamento instantâneo. Sem tempo para o usuário pensar em desistir.',
  ...
  },
  {
    ...
    title: 'UX/UI Magnética',
    description: 'Interface projetada milimetricamente para guiar decisões rápidas e lógicas.',
    className: 'md:col-span-1',
    graphic: 'pulse',
  },
  {
    ...
    title: 'Copy Agressiva',
    description: 'Palavras que geram autoridade instantânea e um desejo incontrolável de compra.',
    className: 'md:col-span-1',
    graphic: 'matrix',
  },
  {
    ...
    title: 'Estrutura Dominante',
    description: 'Construído como um tanque para absorver tráfego em massa e escalar resultados.',
    className: 'md:col-span-1',
    graphic: 'chart',
  },
];
...
export function SolutionSection() {
  return (
    <section className="py-16 md:py-24 bg-[#020202] relative overflow-hidden">
      ...
      {/* Static Cyber Background – no infinite Motion animation */}
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-[1400px] relative z-10">
        ...
        >
          ...
          <p className="mt-8 text-gray-400 font-sans text-lg md:text-xl font-light max-w-2xl leading-relaxed">
            Nós não fazemos sites bonitinhos. Construímos ecossistemas digitais armados até os dentes para capturar, reter e converter tráfego.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 auto-rows-fr">
          ...
          >
            <div className="relative h-full overflow-hidden bg-gradient-to-br from-black/80 to-[#020202] backdrop-blur-xl border border-white/5 transition-all duration-500 p-8 md:p-14 rounded-sm flex flex-col md:flex-row items-center justify-between gap-8 hover:shadow-[0_20px_50px_rgba(103,194,78,0.12)] hover:border-[#67c24e]/50 z-10">
              ...
              {/* CSS scanline instead of Motion */}
              ...
              <div className="relative z-20 space-y-4 md:max-w-xl text-center md:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-sm bg-white/5 border border-white/10 mb-2">
                  ...
                  <span className="text-xs font-mono uppercase tracking-widest text-[#67c24e]">Status: Operacional</span>
                </div>
                <h3 className="text-3xl md:text-5xl font-display font-black uppercase tracking-tight text-white">
                  Pronto para criar sua<br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-[#67c24e]">Máquina de Vendas?</span>
                </h3>
