...
export default function Frame() {
  return (
    <div className="content-stretch flex items-center relative size-full">
      <div className="h-[878.788px] relative shrink-0 w-[599.174px]" data-name="freepik__reate-a-modern-futuristic-logo-for-a-uxui-design-a__41704 1">
      ...
      <div className="h-[878.788px] relative shrink-0 w-[1645.73px]" data-name="freepik__reate-a-modern-futuristic-logo-for-a-uxui-design-a__41704 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
